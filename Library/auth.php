...
<nav class="navbar navbar-inverse bg-success">
    <div class="navbar-header">
        <ul class="nav navbar-nav  ">
            ...
            <li><a class="navbar-brand" href="id.php" ><i class="glyphicon glyphicon-log-in "></i>&nbsp;Student ID</a></li>
            <li><a class="navbar-brand" href="searchbook.php"><i class="glyphicon glyphicon-log-in "></i>&nbsp;Book Search</a></li>
...
$query = "select BAUTH,BPUBL,BISSU,BTITL,BACNO from books where BAUTH like '%$search%'";
